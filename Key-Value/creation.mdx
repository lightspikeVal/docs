...
1. Go to `https://purrscale.com/workspace/your-workspace-name`
...
Congratulations! You've successfully created your first key-value store and learned how to interact with it programmatically. 🎉
